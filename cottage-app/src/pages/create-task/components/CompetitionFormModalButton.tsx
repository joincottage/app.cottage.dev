...
const defaultFigmaLink =
  "https://www.figma.com/embed?embed_host=share&url=https%3A%2F%2Fwww.figma.com%2Fproto%2FisEfS9oIpv2MnN2vuUGXLk%2FUI%3Fnode-id%3D134%253A1509%26starting-point-node-id%3D134%253A1509";
...
export default function CompetitionFormModalButton({ task }: OwnProps) {
  ...
  const handleSave = async () => {
    ...
    const acceptanceCriteriaString =
      formData["Acceptance Criteria Array"].join(";");
    const newTask: Task = {
      Name: formData.Name,
  ...
  const handleAddAC = () => {
    setFormData({
      ...formData,
      ["Acceptance Criteria Array"]: [
        ...formData["Acceptance Criteria Array"],
  ...
  const handleDeleteAC = (content: string) => {
    setFormData((prevFormData) => {
      const index = prevFormData["Acceptance Criteria Array"].findIndex(
        (a) => a === content
      );
          ...
          >
            ...
            <Grid container spacing={2}>
              ...
              >
                ...
                <FormControl fullWidth sx={{ mt: 2 }}>
                  <InputLabel htmlFor="comp-figma-link">
                    Figma Direct Link
                  </InputLabel>
                  <OutlinedInput
                    id="comp-figma-link"
                ...
                <FormControl fullWidth sx={{ mt: 2 }}>
                  <InputLabel htmlFor="comp-figma-embed-link">
                    Figma Embed Link
                  </InputLabel>
                  <OutlinedInput
                ...
                <List>
                  {formData["Acceptance Criteria Array"].map(
                    (a: string, index) => {
                      if (!a || a.trim() === "") return;
                ...
                {addingNewAC && (
                  <FormControl fullWidth sx={{ mt: 2, mb: 2 }}>
                    <InputLabel htmlFor="comp-acceptance-criteria">
                    ...
                    <ButtonGroup
                      ...
                      disableElevation
                    >
                      <Button variant="outlined" onClick={handleCancelAddAC}>
                        Cancel
                      </Button>
                ...
                {showAddACButton && (
                  <Button variant="contained" onClick={handleAddACClick}>
